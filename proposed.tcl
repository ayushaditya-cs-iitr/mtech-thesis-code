...
$ns trace-all $f
set namtrace [open proposed.nam w]
set windowVsTime2 [open wins3.tr w]
set runall [open cluster.bat w]
$ns namtrace-all-wireless $namtrace $val(x) $val(y)
set f0 [open Trust-CM_Overhead.tr w]
set f1 [open Trust-Delay.tr w]
set f2 [open Trust-THROUGHPUT.tr w]
set f3 [open Trust-Packetloss.tr w]
set f4 [open Trust-Powerconsumption.tr w]
...
proc record {} {
  ...
  set now [$ns now]
   puts $f0 "$now [expr ($bw1+$bw2)*1.1]"
   puts $f1 "$now [expr ($bw4)]"
   puts $f2 "$now [expr ($bw4+$bw5+$bw3)/5]"
   puts $f3 "$now [expr ($bw0)]"
   puts $f4 "$now [expr ($bw1+$bw4)]"
...
$ns at 2.1 "$n(17) label CH"
$ns at 2.2 "$n(15) label CH"

$ns at 2.1 "$n(25) label CH"
$ns at 2.2 "$n(32) label CH"
...
$ns at 2.0 "$ns trace-annotate \"election for cluster formation\""
$ns at 2.1 "$ns trace-annotate \"Cluster head selection\""
$ns at 2.3 "$ns trace-annotate \"Sensor nodes aggregating data to CH\""
$ns at 8.8 "$ns trace-annotate \"Cluster head start sending data to sink\""
...
set abc [open values.txt w]
 ## the file with the name value is created and write premission is given
puts $abc "\n  --------------------------------------------------------------------------------------"
puts $abc " \t\tID\t\t Number of packets \tTrust Value"           
 ##### the value file have these fields 
puts $abc "  ----------------------------------------------------------------------------------------\n"
close $abc
...
set max 10
set min 1 
 ###the procedure of distance is created which have four values. The x and y value of first node and second node 
set nbr [open values.txt a]
set x1 [expr int([$n1 set X_])] 
 ## x value of first node 
set y1 [expr int([$n1 set Y_])]  
 ## y value of first node 
set x2 [expr int([$n2 set X_])]  
### x value of second node 
set y2 [expr int([$n2 set Y_])]  
 ### y value of second node 
set d [expr int(sqrt(pow(($x2-$x1),2)+pow(($y2-$y1),2)))/100]
...
if {$d<230} {
if {$nd1==0 && $d<180} {
puts $nbr "\t\t$nd2\t\t$d1\t\t$value"  
## value is displayed in the file
} elseif {$nd1!=0} { puts $nbr "\t\t$nd2\t\t$d1\t\t$value" }  
## value is displayed in the file
}
}
close $nbr
...
$ns at 1.5 "distance $n($i) $n($j) $i $j" 
}
}

#############################
$ns at 8.7 "$n(9) label Detected "
$ns at 8.7 "$n(9) add-mark m1 red circle"
############################################
...
###########################################################3
set cbr38 [attach-CBR-traffic $n(17) $sink24 1000 .05]
set cbr39 [attach-CBR-traffic $n(25) $sink24 1000 .05]
set cbr40 [attach-CBR-traffic $n(32) $sink24 1000 .05]
set cbr41 [attach-CBR-traffic $n(15) $sink24 1000 .05]
set cbr42 [attach-CBR-traffic $n(9) $sink24 1000 .05]
################################################
...
########################################################
set cbr38 [attach-CBR-traffic $n(25) $sink7 1000 .05]
set cbr39 [attach-CBR-traffic $n(7) $sink17 1000 .05]
set cbr40 [attach-CBR-traffic $n(17) $sink24 1000 .05]


$ns at 0.0 "record"

$ns at 0.0 "$cbr38 start"
$ns at 0.0 "$cbr39 start"
$ns at 0.0 "$cbr40 start"
$ns at 0.0 "$cbr41 start"
$ns at 0.0 "$cbr42 start"

$ns at 2.4 "$cbr38 stop"
$ns at 2.4 "$cbr39 stop"
$ns at 2.4 "$cbr40 stop"
$ns at 2.4 "$cbr41 stop"
$ns at 2.4 "$cbr42 stop"
...
$ns at 2.5 "$cbr5 start"
$ns at 2.5 "$cbr6 start"
$ns at 2.5 "$cbr7 start"
...
$ns at 4.5 "$cbr10 start"
$ns at 4.5 "$cbr11 start"
$ns at 4.5 "$cbr12 start"
$ns at 4.5 "$cbr13 start"
$ns at 4.5 "$cbr14 start"
$ns at 4.5 "$cbr15 start"
$ns at 4.5 "$cbr16 start"
$ns at 4.5 "$cbr17 start"
$ns at 4.5 "$cbr18 start"
$ns at 4.5 "$cbr19 start"


$ns at 6.5 "$cbr10 stop"
$ns at 6.5 "$cbr11 stop"
$ns at 6.5 "$cbr12 stop"
$ns at 6.5 "$cbr13 stop"
$ns at 6.5 "$cbr14 stop"
$ns at 6.5 "$cbr15 stop"
$ns at 6.5 "$cbr16 stop"
$ns at 6.5 "$cbr17 stop"
$ns at 6.5 "$cbr18 stop"
$ns at 6.5 "$cbr19 stop"


$ns at 6.6 "$cbr20 start"
$ns at 6.6 "$cbr21 start"
$ns at 6.6 "$cbr22 start"
$ns at 6.6 "$cbr23 start"
$ns at 6.6 "$cbr24 start"
$ns at 6.6 "$cbr25 start"

$ns at 7.5 "$cbr20 stop"
$ns at 7.5 "$cbr21 stop"
$ns at 7.5 "$cbr22 stop"
$ns at 7.5 "$cbr23 stop"
$ns at 7.5 "$cbr24 stop"
$ns at 7.5 "$cbr25 stop"

###############################
$ns at 7.6 "$cbr26 start"
$ns at 7.6 "$cbr27 start"
$ns at 7.6 "$cbr28 start"
$ns at 7.6 "$cbr29 start"
$ns at 7.6 "$cbr30 start"

$ns at 8.6 "$cbr26 stop"
$ns at 8.6 "$cbr27 stop"
$ns at 8.6 "$cbr28 stop"
$ns at 8.6 "$cbr29 stop"
$ns at 8.6 "$cbr30 stop"

$ns at 9.0 "$cbr38 start"
$ns at 9.0 "$cbr39 start"
$ns at 9.0 "$cbr40 start"
