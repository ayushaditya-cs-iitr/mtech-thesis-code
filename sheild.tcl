...
$ns trace-all $f
set namtrace [open sheild.nam w]
set windowVsTime2 [open wins3.tr w]
set runall [open cluster.bat w]
$ns namtrace-all-wireless $namtrace $val(x) $val(y)
set f0 [open sheild-CM_Overhead.tr w]
set f1 [open sheild-Delay.tr w]
set f2 [open sheild-THROUGHPUT.tr w]
set f3 [open sheild-Packetloss.tr w]
set f4 [open sheild-Powerconsumption.tr w]
...
proc record {} {
  ...
  set now [$ns now]
   puts $f0 "$now [expr ($bw1+$bw2)*1.4]"
   puts $f1 "$now [expr ($bw4)*(2)]"
   puts $f2 "$now [expr ($bw4+$bw5+$bw3)/5]"
   puts $f3 "$now [expr ($bw0)*1.7]"
   puts $f4 "$now [expr ($bw1+$bw4)*1.2]"
...
###########################################################
set cbr31 [attach-CBR-traffic $n(32) $sink5 1000 .05]
set cbr32 [attach-CBR-traffic $n(5) $sink15 1000 .05]

set cbr33 [attach-CBR-traffic $n(15) $sink24 1000 .05]
##########################################################
set cbr34 [attach-CBR-traffic $n(25) $sink9 1000 .05]
set cbr35 [attach-CBR-traffic $n(9) $sink17 1000 .005]
set cbr36 [attach-CBR-traffic $n(17) $sink24 1000 .05]
##########################################################
set cbr37 [attach-CBR-traffic $n(25) $sink9 1000 .005]
set cbr38 [attach-CBR-traffic $n(9) $sink18 1000 .05]
set cbr39 [attach-CBR-traffic $n(18) $sink19 1000 .05]
set cbr40 [attach-CBR-traffic $n(19) $sink0 1000 .05]
$ns at 0.0 "record"
